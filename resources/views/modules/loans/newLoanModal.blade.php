...
<div class="modal animated bounceInUp text-left" id="newLoanModal" role="dialog" aria-labelledby="newLoanModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" idw="newLoanModal"><h3 class="mb-0">Agregar deuda manualmente</h3></label>
