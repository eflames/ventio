...
<div class="modal animated bounceInLeft text-left" id="newCreditModal" role="dialog" aria-labelledby="newCreditModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-orange">
                <label class="modal-title text-text-bold-600" idw="newCreditModal"><h3 class="text-white">Agregar credito a favor</h3></label>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" class="text-white">&times;</span>
                </button>
            </div>
            {{ Form::open(['url' => 'cuentas/por-pagar', 'method' => 'post']) }}
