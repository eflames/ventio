...
<div class="modal animated bounceInUp text-left" id="newCreditModal" role="dialog" aria-labelledby="newCreditModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" idw="newCreditModal"><h3 class="mb-0">Agregar credito a favor</h3></label>
