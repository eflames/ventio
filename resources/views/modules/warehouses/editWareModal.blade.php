...
<div class="modal animated bounceInLeft text-left" id="editWareModal" role="dialog" aria-labelledby="editWareModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-pink">
                <label class="modal-title text-text-bold-600" id="editWareModal"><h3 class="text-white modal-title-changed"></h3></label>
