...
<div class="modal animated bounceInUp text-left" id="changePriceModalFull" role="dialog" aria-labelledby="changePriceModalFull" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="changePriceModalFull"><h3 class="mb-0 modal-title-changed"></h3></label>
