...
<div class="modal animated bounceInUp text-left" id="returnModal" role="dialog" aria-labelledby="returnModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600"><h3 class="bg modal-title-changed"></h3></label>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-green btn-lg ld-ext-right">Devolver
