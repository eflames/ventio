                ...
                <div class="col-12">
                    <div class="card border-top-3 border-top-green">
                        <div class="card-header">
                            <h4 class="card-title">Editar producto <small><span class="text-danger">*</span> son campos obligatorios</small></h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                {{ Form::model($product, ['url' => ['/productos', $product->id], 'method' => 'patch']) }}
