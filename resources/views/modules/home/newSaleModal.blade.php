...
<div class="modal animated bounceInUp text-left masterModal" id="newSaleModal" role="dialog" aria-labelledby="newSaleModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" idw="newSaleModal"><h3 class="mb-0">Nueva venta</h3></label>
