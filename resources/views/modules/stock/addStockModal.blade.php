...
<div class="modal animated bounceInUp text-left" id="addStockModal" role="dialog" aria-labelledby="addStockModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="addStockModal">
                    <h3 class="modal-title-changed mb-0">
                        Agregar nuevo stock
                    </h3>
                </label>
            ...
            {{ Form::open(['route' => 'stock.store', 'method' => 'post']) }}
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <fieldset class="form-group form-group-style">
                                <label for="cost_price" class="filled">Stock Mínimo:</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-light-green btn-lg ld-ext-right">Agregar
