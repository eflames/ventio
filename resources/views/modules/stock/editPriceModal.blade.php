...
<div class="modal animated bounceInUp text-left" id="editPriceModal" role="dialog" aria-labelledby="editPriceModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light bg-darken-3">
                <label class="modal-title text-text-bold-600" id="editPriceModal"><h3 class="modal-title-changed mb-0"></h3></label>
