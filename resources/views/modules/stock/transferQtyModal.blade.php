...
<div class="modal animated bounceInUp text-left" id="transferQtyModal" role="dialog" aria-labelledby="transferQtyModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="transferQtyModal"><h3 class="modal-title-changed mb-0"></h3></label>
            ...
            {{ Form::open(['url' => 'stock/transfer', 'method' => 'post']) }}
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-light-green btn-lg ld-ext-right">Transferir
