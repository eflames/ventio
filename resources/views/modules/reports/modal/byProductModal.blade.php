 ...
 * Time: 2:37 AM
 */?>
<div class="modal animated bounceInLeft text-left" id="byProductModal" role="dialog" aria-labelledby="byProductModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-indigo">
                <label class="modal-title text-text-bold-600" id="byProductModal"><h3 class="text-white">Generar por producto</h3></label>
