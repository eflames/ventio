 ...
 * Time: 2:37 AM
 */?>
<div class="modal animated bounceInUp text-left report-modal" id="byReturnModal" role="dialog" aria-labelledby="byReturnModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="byReturnModal"><h3 class="mb-0">Generar por devoluciones</h3></label>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {{ Form::open(['route' => 'report.byReturn', 'method' => 'post']) }}
