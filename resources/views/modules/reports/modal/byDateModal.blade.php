 ...
 * Time: 2:37 AM
 */?>
<div class="modal animated bounceInUp text-left report-modal" id="byDateModal" role="dialog" aria-labelledby="byDateModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="byDateModal"><h3 class="mb-0">Generar por fecha</h3></label>
