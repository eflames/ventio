 ...
 * Time: 2:37 AM
 */?>
<div class="modal animated bounceInLeft text-left" id="byProfitModal" role="dialog" aria-labelledby="byProfitModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-indigo">
                <label class="modal-title text-text-bold-600" id="byProfitModal"><h3 class="text-white">Generar por ganancias</h3></label>
