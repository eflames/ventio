 ...
 * Time: 2:37 AM
 */?>
<div class="modal animated bounceInUp text-left report-modal" id="byProfitModal" role="dialog" aria-labelledby="byProfitModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="byProfitModal"><h3 class="mb-0">Generar por ganancias</h3></label>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            {{ Form::open(['route' => 'report.byProfit', 'method' => 'post']) }}
