 ...
 * Time: 2:37 AM
 */?>
<div class="modal animated bounceInUp text-left report-modal" id="byClientModal" role="dialog" aria-labelledby="byClientModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="byClientModal"><h3 class="mb-0">Generar por cliente</h3></label>
