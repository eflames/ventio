...
<div class="modal animated bounceInUp text-left modal-pay" id="editMethodModal" role="dialog" aria-labelledby="editMethodModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <label class="modal-title text-text-bold-600" id="editMethodModal"><h3 class="mb-0 modal-title-changed"></h3></label>
