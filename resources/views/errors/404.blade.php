...
<section class="section mt-5">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <div>
                    <img alt="404" class="img-fluid" src="{{ asset('images/404.png') }}" />
                </div>
            </div>
            <div class="col-md-6 col-lg-5 d-flex align-items-center mt-4 mt-md-0">
                <div>
                    <h1>404 - Página no encontrada</h1>
                    <p class="margin-top-s">Lo sentimos, la página que buscas no existe, revisa la dirección e inténtalo de nuevo.</p>
